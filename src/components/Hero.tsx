    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-emerald-900 to-green-900 overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          {/* Redesigned Dr. Neto Section - Mobile Optimized */}
          <div className="mb-12 animate-scale-in">
            <div className="bg-gradient-to-r from-slate-800/50 to-slate-900/50 backdrop-blur-lg rounded-3xl p-4 sm:p-8 border border-emerald-500/20 shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500">
              <div className="flex flex-col items-center space-y-4 sm:space-y-6">
                {/* Avatar and Title */}
                <div className="flex flex-col items-center space-y-3 sm:space-y-4">
                  <div className="relative">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-emerald-400 to-green-500 rounded-full flex items-center justify-center shadow-lg">
                    ...
                    <div className="absolute -top-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 bg-yellow-400 rounded-full flex items-center justify-center">
                      <Sparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-yellow-800" />
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-center space-x-2 sm:space-x-3 bg-slate-800/30 rounded-full px-4 py-2 sm:px-6 sm:py-3 border border-slate-600/30">
                  <span className="text-slate-300 text-xs sm:text-sm">Siga-me:</span>
                  <a 
                    href="https://instagram.com/netoscardovelli" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center space-x-1.5 sm:space-x-2 text-emerald-400 hover:text-emerald-300 transition-colors duration-200 font-semibold group"
                  >
                    <Instagram className="w-3.5 h-3.5 sm:w-4 sm:h-4 group-hover:scale-110 transition-transform" />
                    <span className="text-xs sm:text-sm">@netoscardovelli</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          {/* Enhanced Subtitle */}
          <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in px-4" style={{ animationDelay: '0.2s' }}>
            IA TREINADA POR MÉDICO PARA AUXILIAR NO SEU DIA A DIA DO CONSULTÓRIO
          </p>

          {/* Enhanced CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-20 animate-fade-in px-4" style={{ animationDelay: '0.4s' }}>
            <Button 
              size="lg" 
              onClick={onGetStarted}
              className="group bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white px-8 sm:px-10 py-4 sm:py-5 text-base sm:text-lg font-semibold rounded-2xl shadow-2xl hover:shadow-emerald-500/25 transform hover:scale-105 transition-all duration-300 border border-emerald-400/30 w-full sm:w-auto"
            >
              <Zap className="mr-2 sm:mr-3 w-4 h-4 sm:w-5 sm:h-5 group-hover:animate-pulse" />
              Começar Análise
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-slate-400 text-slate-300 hover:bg-slate-800 hover:border-emerald-400 px-8 sm:px-10 py-4 sm:py-5 text-base sm:text-lg rounded-2xl backdrop-blur-sm hover:scale-105 transition-all duration-300 w-full sm:w-auto"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-6xl mx-auto px-4">
            {[
              {
                icon: FlaskConical,
              ...
              <div key={index} className="group text-center animate-fade-in" style={{ animationDelay: feature.delay }}>
                <div className="relative mb-6">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-emerald-500 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-emerald-500/25">
                    <feature.icon className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
                  </div>
                  {/* Decorative ring */}
                  <div className="absolute -top-2 -left-2 w-18 h-18 sm:w-20 sm:h-20 border-2 border-emerald-400/20 rounded-2xl mx-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
                <h3 className="text-base sm:text-lg font-semibold text-white mb-3 group-hover:text-emerald-300 transition-colors">
                  {feature.title}
                </h3>
